...
/**
 * Function class for the vertical flip command.
 */
public class VerticalFlipCommandFunc extends TwoArgCommandFunc {
  ...
  protected String getCommandErrorMsg() {
    return "vertical-flip command expected image-name, and dest-image-name as the arguments " +
  ...
  protected Command createCommand(String userInput1, String userInput2) {
    return new VerticalFlipCommand(userInput1, userInput2);
  }
}
